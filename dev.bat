@echo off
REM =============================================================================
REM HYDRA-UMC GATEWAY INDUSTRIAL - Development Server Start Script
...
echo ========================================
echo  Starting HYDRA-UMC GATEWAY INDUSTRIAL (Dev Mode)
echo ========================================
call npm run dev
if errorlevel 1 (
  echo.
  echo HYDRA-UMC GATEWAY INDUSTRIAL exited with an error.
  pause
  exit /b 1
)
pause
